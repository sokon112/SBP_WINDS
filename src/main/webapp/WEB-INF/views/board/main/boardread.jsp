                	...
                	<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                			<form action="" role="form">
                				...
                				<button type="button" class="btn btn-info pull-right" onclick="location.href='boardlist'">목록</button>
                				<button type="button" style="margin-right:3px;" name="delete" value="${board.bno}" class="btn btn-danger pull-right">삭제</button>
                				<button type="button" style="margin-right:3px;" name="modify" value="${board.bno}" class="btn btn-warning pull-right" id="modifyBtn">수정</button>
