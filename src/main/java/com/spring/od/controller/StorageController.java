...
public class StorageController {
	...
	public void waitList(Model model,Criteria cri) {
		...
		List<StorageListVO> waitlist = service.WaitList(cri);
	...
	public void completeList(Model model,Criteria cri) {
		...
		List<StorageListVO> completelist = service.CompleteList(cri);
	...
	public void templist(Model model,Criteria cri) {
		...
		List<StorageListVO> templist = service.TempList(cri);
